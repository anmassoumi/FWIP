...
Additionally, I’ve been involved in the actual fabrication process — slicing the models, setting print parameters, and troubleshooting printing issues with different filament types. Through this hands-on process, I’ve developed a deeper understanding of additive manufacturing, print orientation strategies, and post-processing techniques like sanding, bonding, and reinforcement.

Being part of FWIP has not only strengthened my technical skills in mechanical design and manufacturing, but has also taught me valuable lessons in cross-functional teamwork, time management, and iterative problem-solving under real project deadlines. It’s an incredibly rewarding experience to see our ideas move from sketches to flying aircraft, and to contribute meaningfully to a student-built engineering project that simulates real-world aerospace workflows.
